...
//                .forEach(System.out::println);
        ...
        System.out.println("ZonedDateTime using clock : " + ZonedDateTime.now(Clock.system(ZoneId.of("America/Detroit"))));
        ...
        ZonedDateTime zonedDateTime1 = localDateTime3.atZone(ZoneId.of("America/Bogota"));
        System.out.println("zonedDateTime1 : " + zonedDateTime1);

        ZonedDateTime zonedDateTime2 = Instant.now().atZone(ZoneId.of("America/Bogota"));
